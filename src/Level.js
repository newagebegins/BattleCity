function Level(eventManager) {
  ...
  var enemyTank1 = new Tank(eventManager);
  enemyTank1.setPosition(new Point(this._x + 4 * Globals.UNIT_SIZE, this._y));
  enemyTank1.setState(new TankStateAppearing(enemyTank1));
  enemyTank1.setType(Tank.Type.BASIC);
  
  var enemyTank2 = new Tank(eventManager);
  enemyTank2.setPosition(new Point(this._x + 12 * Globals.UNIT_SIZE, this._y));
  enemyTank2.setState(new TankStateAppearing(enemyTank2));
  enemyTank2.setType(Tank.Type.FAST);
