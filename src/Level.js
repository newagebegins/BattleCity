function Level(eventManager) {
  ...
  enemyTank.setPosition(new Point(this._x + 4 * Globals.UNIT_SIZE, this._y));
  enemyTank.setState(new TankStateAppearing(enemyTank));
  enemyTank.setType(Tank.Type.BASIC);
